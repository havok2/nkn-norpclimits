nkn@NBlock:~/nkn.sync$ cat api/httpjson/RPCserver.go
package httpjson
...
func (s *RPCServer) Handle(w http.ResponseWriter, r *http.Request) {
	...
	if err == nil {
		...
		//	return
		// }
		_ = limiter // Suppress unused variable warning
	}

	// DISABLED: Global rate limiting for blockchain sync performance
	// if !s.limiter.Allow() {
